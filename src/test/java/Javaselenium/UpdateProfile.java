...
public class UpdateProfile {
	...
	public static void main(String[] args) {
		...
		WebElement Updateinfo = driver.findElement(By.xpath("//a[normalize-space()='Update Contact Info']"));
		Updateinfo.click();

		WebElement Updateprofile = driver.findElement(By.xpath("//input[@value='Update Profile']"));
		Updateprofile.click();
